...
public class UserDB implements Serializable{
    ...
    private final static String LOGIN_FILE = "Backend/files/login.txt";
    private final static String DATA_FILE = "Backend/files/userdata.txt";
    ...
    public static boolean udpateExpense(Expense e, String newDescription){
        User user = loadUsers().get(currUser);
        if (user.updateExpense(e, newDescription)){
            saveUser(user);
            return true;
        }
        return false;
    ...
    public static void main(String [] args){
        ...
        System.out.println(users.get("mrafko").toString());
    }
}